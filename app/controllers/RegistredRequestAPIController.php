...
class RegistredRequestAPIController extends BaseController {
    /*
      |-------------------------------------------------------------------------
     ...
     * 
     * 
     * @return \Illuminate\View\View  return result search news
     */
     ...
     * 
     * @return \Illuminate\View\View  display the desired news and reviews
     */
     ...
     * @return \Illuminate\View\View Returns form changes with the corresponding message
     */
