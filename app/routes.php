...
Route::get('api.test1.api/news/search/{name}', 'APINewsController@searchJSONNews');

Route::get('api.test1.api/news/tag/search/{tag}', 'APINewsController@searchJSONNewsTag');
